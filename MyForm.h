...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->nUDPoids = (gcnew System::Windows::Forms::NumericUpDown());
			this->gbBalance = (gcnew System::Windows::Forms::GroupBox());
			this->gBConnection->SuspendLayout();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->nUDPort))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->nUDPoids))->BeginInit();
			...
			// nUDPoids
			// 
			this->nUDPoids->Location = System::Drawing::Point(72, 45);
			this->nUDPoids->Maximum = System::Decimal(gcnew cli::array< System::Int32 >(4) { 9999, 0, 0, 0 });
			this->nUDPoids->Name = L"nUDPoids";
			this->nUDPoids->Size = System::Drawing::Size(120, 20);
			this->nUDPoids->TabIndex = 3;
			// 
			// gbBalance
			// 
			this->gbBalance->Controls->Add(this->nUDPoids);
			this->gbBalance->Location = System::Drawing::Point(12, 118);
			this->gbBalance->Name = L"gbBalance";
			this->gbBalance->Size = System::Drawing::Size(386, 100);
			this->gbBalance->TabIndex = 4;
			this->gbBalance->TabStop = false;
			this->gbBalance->Text = L"Balance";
			// 
			// MyForm
			// 
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->nUDPoids))->EndInit();
	...
	private: System::Void timerUpdate_Tick(System::Object^  sender, System::EventArgs^  e) {
		if (stateCl)
		{
			...
			try
			{
				...
				} while (pm->type != p->GetTypeProtocoleByID("baDPoids"));

				cl->Send(p->RetourGetBalancePoids((int)nUDPoids->Value));
